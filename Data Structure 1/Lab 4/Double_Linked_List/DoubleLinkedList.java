...
public class DoubleLinkedList implements ILinkedList {
    ...
    static int size = 0;
    static DoubleLinkedList singleList = new DoubleLinkedList();
    ...
    public void remove(int index) {
        ...
        if (counter == index) {
            if (singleList.head == null) {
                ...
                singleList.head.next.prev = null;
            }
        } else {
            counter++;
            Node current = singleList.head;
    ...
    public void prints(DoubleLinkedList singleList) {
        System.out.print("[");
